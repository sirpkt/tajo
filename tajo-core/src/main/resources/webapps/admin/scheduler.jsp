...
<%@ page import="org.apache.tajo.master.QueryManager" %>
<%@ page import="org.apache.tajo.master.scheduler.Scheduler" %>
<%@ page import="org.apache.tajo.webapp.StaticHttpServer" %>

<%
    TajoMaster master = (TajoMaster) StaticHttpServer.getInstance().getAttribute("tajo.info.server.object");
    TajoMaster.MasterContext masterContext = master.getContext();
    QueryManager manager = masterContext.getQueryJobManager();
